# ----------------------------------------------------------------------
#   LIGGGHTS - Large-scale Atomic/Molecular Massively Parallel Simulator
...
#
#   See the README file in the top-level LIGGGHTS directory.
# -------------------------------------------------------------------------

# Python wrappers on LIGGGHTS library via ctypes

# for python3 compatibility

from __future__ import print_function

# imports for simple LIGGGHTS python wrapper module "liggghts"
...
# imports for advanced LIGGGHTS python wrapper modules "PyLiggghts" and "IPyLiggghts"
...
class liggghts(object):
  ...
  def __init__(self,name="",cmdargs=None,ptr=None,comm=None):
    ...
    # if a pointer to a LIGGGHTS object is handed in,
    ...
    #   of liggghts.py with an absolute path,
    ...
    if not self.lib:
      try:
        ...
        else: self.lib = CDLL(join(modpath,"libliggghts_%s.so" % name),
                              RTLD_GLOBAL)
      except:
...
class PyLiggghts(object):
  ...
  def __init__(self,name="",cmdargs=None,ptr=None,comm=None):
    if ptr:
      ...
      self.lmp = liggghts(name=name,cmdargs=cmdargs,ptr=None,comm=comm)
    print("LIGGGHTS output is captured by PyLiggghts wrapper")
    self._cmd_history = []
    self.runs = []
